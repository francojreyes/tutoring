// Implementation of Set ADT using an ordered linked list
// Taken from COMP2521 23T3 lectures
// https://cgi.cse.unsw.edu.au/~cs2521/23T3/lectures/code/wk3-adts/set/SetOrderedList.c
